...
class Role extends Model
{
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->setTable(config('admin-panel.table_names.roles', 'roles'));
    }
    ...
    public function permissions()
    {
        return $this->belongsToMany(
            Permission::class,
            config('admin-panel.table_names.role_permission', 'role_permission'),
            'role_id',
            'permission_id'
        );
    }
    ...
    {
        $userModel = config('admin-panel.user_model', \Sndpbag\AdminPanel\Models\User::class);
        return $this->belongsToMany(
            $userModel,
            config('admin-panel.table_names.user_role', 'user_role'),
            'role_id',
            'user_id'
        );
    }
