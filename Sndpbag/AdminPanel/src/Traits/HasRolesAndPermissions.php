...
trait HasRolesAndPermissions
{
    ...
    public function directPermissions()
    {
        return $this->belongsToMany(
            Permission::class,
            config('admin-panel.table_names.user_permission', 'user_permission'),
            'user_id',
            'permission_id'
        );
    }
    ...
    protected function getAllPermissionsFromCache()
    {
        ...
        $cacheDuration = config('admin-panel.cache_duration', 60);
    ...
    {
        $superAdminRole = config('admin-panel.super_admin_role', 'super-admin');
